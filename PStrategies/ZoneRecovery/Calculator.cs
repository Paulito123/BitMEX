namespace PStrategies.ZoneRecovery
{
    ...
    public class Calculator
    {
        ...
        ///// </summary>
        //private ZoneRecoveryStuff CurrentStatus;
        ...
        //    CurrentStatus = ZoneRecoveryStuff.Init;
        //    SyncPositions();
        //    CurrentZRPosition = 0;
        //    UnitSize = 0;
        //}
        ...
        //{
        //    if (CurrentStatus == ZoneRecoveryStuff.Winding)
        //    {
        //        CurrentZRPosition++;

        //        // Zone Recovery logic is reversed
        //        if (CurrentZRPosition == MaxDepthIndex)
        //            CurrentStatus = ZoneRecoveryStuff.Unwinding;
        //    }
        //    else if (CurrentStatus == ZoneRecoveryStuff.Unwinding)
        //    {
        //        CurrentZRPosition--;

        //        // Reset the calculator
        //        if (CurrentZRPosition == 0)
        //            CurrentStatus = ZoneRecoveryStuff.Finish;
        //    }
        //    else if (CurrentStatus == ZoneRecoveryStuff.Init)
        //    {
        //        CurrentStatus = ZoneRecoveryStuff.Winding;
        //        CurrentZRPosition++;
        //    }
        //}
        ...
        //{
        //    if (CurrentStatus == ZoneRecoveryStuff.Init)
        //        return 1;
        //    else if (CurrentStatus == ZoneRecoveryStuff.Winding)
        //        return CurrentZRPosition + 1;
        //    else if (CurrentStatus == ZoneRecoveryStuff.Unwinding)
        //        return CurrentZRPosition - 1;
        //    else if (CurrentStatus == ZoneRecoveryStuff.Alert)
        //        return -1;
        //    else
        //        return 0;
        //}
        ...
        //            if (CurrentStatus == ZoneRecoveryStuff.Winding || CurrentStatus == ZoneRecoveryStuff.Init || CurrentStatus == ZoneRecoveryStuff.Unwinding)
        ...
        //    catch (Exception e)
        //    {
        //        CurrentStatus = ZoneRecoveryStuff.Alert;
        //        inSync = false;
        //    }
        //    return inSync;
        //}
        ...
        //    else if (outputType == ZoneRecoveryOrderType.REV && (CurrentStatus == ZoneRecoveryStuff.Init || CurrentStatus == ZoneRecoveryStuff.Winding))
        //        // Return oposite account when winding or init
        //        return Connections.Where(c => c.Key != TPAccount).Select(c => c.Key).First();
        //    else if (outputType == ZoneRecoveryOrderType.REV && CurrentStatus == ZoneRecoveryStuff.Unwinding)
        ...
        //                if (CurrentStatus == ZoneRecoveryStuff.Unwinding || CurrentStatus == ZoneRecoveryStuff.Winding)
        //                {
        //                    // ----------
        //                    exitCode = 3;
        //                    // ----------
        ...
        //                    }
        //                }
        //                else if (CurrentStatus == ZoneRecoveryStuff.Init)    // No Application orders OR ZoneRecoveryStatus = Init
        //                {
        //                    // ----------
        //                    exitCode = 12;
        //                    // ----------
        ...
        //                    // ----------
        //                }
        //                else if (CurrentStatus == ZoneRecoveryStuff.Finish)
        //                {
        //                    // ----------
        //                    exitCode = 18;
        //                    // ----------
...
//}
        ...
        //public ZoneRecoveryStuff GetStatus()
        //{
