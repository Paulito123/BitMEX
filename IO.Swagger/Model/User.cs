...
namespace IO.Swagger.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        /// <param name="restrictedEngineFields">restrictedEngineFields.</param>
        ...
        public User(decimal? id = default(decimal?), decimal? ownerId = default(decimal?), string firstname = default(string), string lastname = default(string), string username = default(string), string email = default(string), string phone = default(string), DateTime? created = default(DateTime?), DateTime? lastUpdated = default(DateTime?), UserPreferences preferences = default(UserPreferences), Object restrictedEngineFields = default(Object), string tFAEnabled = default(string), string affiliateID = default(string), string pgpPubKey = default(string), string country = default(string), string geoipCountry = default(string), string geoipRegion = default(string), string typ = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets RestrictedEngineFields
        /// </summary>
        [DataMember(Name="restrictedEngineFields", EmitDefaultValue=false)]
        public Object RestrictedEngineFields { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RestrictedEngineFields: ").Append(RestrictedEngineFields).Append("\n");
        ...
        public bool Equals(User input)
        {
            ...
            return 
                ...
                (
                    this.RestrictedEngineFields == input.RestrictedEngineFields ||
                    (this.RestrictedEngineFields != null &&
                    this.RestrictedEngineFields.Equals(input.RestrictedEngineFields))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RestrictedEngineFields != null)
                    hashCode = hashCode * 59 + this.RestrictedEngineFields.GetHashCode();
