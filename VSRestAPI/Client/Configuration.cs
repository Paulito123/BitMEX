 ...
 * #### Getting Started  Base URI: [https://testnet.bitmex.com/api/v1](/api/v1)  
 * ##### Fetching Data  All REST endpoints are documented below. You can try out any query right from this interface.  
 ...
 * *All* table data is available via the [Websocket](/app/wsAPI). We highly recommend using the socket if you want to have the quickest 
 * possible data without being subject to ratelimits.  ##### Return Types  By default, all data is returned as JSON. Send `?_format=csv` 
 * to get CSV data or `?_format=xml` to get XML data.  ##### Trade Data Queries  *This is only a small subset of what is available, to 
 * get you started.*  Fill in the parameters and click the `Try it out!` button to try any of these queries.  
...
namespace OpenAPI.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://testnet.bitmex.com/api/v1";      //https://localhost/api/v1
        ...
        public Configuration(
            ...
            string basePath = "https://testnet.bitmex.com/api/v1") : this()
        {
        ...
        {
            String report = "C# SDK (OpenAPI) Debug Report:\n";
