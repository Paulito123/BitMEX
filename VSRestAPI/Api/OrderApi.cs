...
namespace OpenAPI.Api
{
    ...
    public interface IOrderApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// </summary>
        /// <remarks>
        /// Useful as a dead-man&#39;s switch to ensure your orders are canceled in case of an outage. If called repeatedly, the existing offset will be canceled and a new one will be inserted in its place.  Example usage: call this route at 15s intervals with an offset of 60000 (60s). If this route is not called within 60 seconds, all your orders will be automatically canceled.  This is also available via [WebSocket](https://testnet.bitmex.com/app/wsAPI#Dead-Mans-Switch-Auto-Cancel). 
        /// </remarks>
        /// <exception cref="OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="filter">Generic table filter. Send JSON key/value pairs, such as &#x60;{\&quot;key\&quot;: \&quot;value\&quot;}&#x60;. You can key on individual fields, and do more advanced querying on timestamps. See the [Timestamp Docs](https://testnet.bitmex.com/app/restAPI#Timestamp-Filters) for more details. (optional)</param>
    ...
    {
        private OpenAPI.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new OpenAPI.Client.Configuration { BasePath = basePath };
        ...
        /// <returns></returns>
        public OrderApi(OpenAPI.Client.Configuration configuration = null)
        {
            if (configuration == null) // use the default one in Configuration
                this.Configuration = OpenAPI.Client.Configuration.Default;
            else
        ...
        public OpenAPI.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public OpenAPI.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
